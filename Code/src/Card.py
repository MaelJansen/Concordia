...
class God:
    ...
    def __init__(self, diety_name):
        ...
        """
        self.name: str = diety_name
        self.significance: str = None
        self.rewards: str = None
        self.example: str = None
        self.victory_points: int = None
        ...
        match self.name:
            ...
            case "Jupiter":
                ...
                for houses in player.my_houses:
                    if vp < 15 and \
                        houses.assigned_city_token.assigned_ressource \
                            != "Brick":
                        vp += 1
                player.n_point += vp
            ...
            case "Saturnus":
                ...
                for provinces in map:
                    for city in provinces:
                        if player.house == city and city \
                            not in conquered_provinces:
            ...
            case "Mercurius":
                ...
                for house in player.my_houses:
                    if house.houses.assigned_city_token.assigned_ressource \
                            not in producted_resources:
                        producted_resources.append(
