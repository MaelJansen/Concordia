...
class ResourceType:
    ...
    def setup_resource_types(data):
        for r_t in data:
            resource_name, resource_price, resource_color, resource_bonus_value, build_cost = r_t[
                0], r_t[1], r_t[2], r_t[3], r_t[4]
            res_type_obj = ResourceType(
                resource_name, resource_price, resource_bonus_value, build_cost, resource_color)
